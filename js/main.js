...
function initYouTubePlaceholder() {
  ...
  iframes.forEach(iframe => {
    ...
    placeholder.innerHTML = `
      <p class="yt-placeholder__title">${title}</p>
      <button class="yt-placeholder__btn" aria-label="Video laden">
        <svg viewBox="0 0 24 24" width="32" height="32" aria-hidden="true"><path d="M8 5v14l11-7z" fill="#fff"/></svg>
        Video laden (YouTube)
      </button>
      <p class="yt-placeholder__note">Mit dem Klick wird das Video von YouTube geladen.<br>Dabei setzt YouTube (Google) Cookies. <a href="datenschutz.html">Datenschutz</a></p>`;
